...
Pour des problèmatiques de temps de calcul, nous n'avons pas calculé la sensibilité elle mêmes, mais nous avons affiché sur des graphiques les courbes de convergence des BE pour différentes valeurs pour chaque paramètre étudié, ceteris paribus.
...
Pour ce qui est du modèle de taux forward HJM, on observe que modifier les deux paramètres qui le composent ne change pas les résultats significativement, cela ne fait que bruiter.
