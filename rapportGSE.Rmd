...
Pour ce qui est de la consistence de marché, nous ne sommes ici pas en mesure de la valdider. En effet, le seul paramètre d'entrée de nos modèles est la courbe de taux de l'EIOPA. Nous n'avons aucune base de comparaison que nous exploitons ici en guise de référence du marché. Ainsi, on arrive toujours à affirmer que la consistence de marché avec l'EIOPA est validée sous réserve que le code est bien écrit. 
