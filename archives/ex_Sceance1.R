...
# Sans précision sur le paramétrage, simuler et observe des valeurs actions
...
calc.temps(50,1:1000)$z %>% as.vector %>% plot 
...
abline(h = mean(tail(Be,floor(length(Be)/2))))
...
# liste de quelques mémoires pertinants.
